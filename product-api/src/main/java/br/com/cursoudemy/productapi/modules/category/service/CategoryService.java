...
public class CategoryService {
    ...
    public SuccessResponse delete(Integer id) {
        ...
        if (productService.existsByCategoryId(id)) {
            throw new ValidadionException("You cannot delete this category because it's already defined by a product.");
        }
    ...
    private void validateInformedId(Integer id) {
        if (isEmpty(id)) {
            throw new ValidadionException("The category ID must be informed.");
        }
    }
}
